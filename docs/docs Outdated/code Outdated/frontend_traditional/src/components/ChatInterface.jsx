...
function ChatInterface() {
    const [messages, setMessages] = useState([
        {
            role: 'agent',
            content: "Hi! I'm your AI insurance agent powered by Google Gemini. I can help you get personalized quotes for auto or home insurance. What would you like to know?"
        }
    ]);
                    ...
                    <div className="flex gap-3 items-end">
                        <div className="flex-1 relative">
                            <textarea
                                ...
                                placeholder="Ask me about auto or home insurance..."
